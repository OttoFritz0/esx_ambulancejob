...
Config.Hospitals = {
	...
	CentralLosSantos = {
		...
		Helicopters = {
			{
				Spawner = vector3(293.3, -598.63, 43.3),
				InsideShop = vector3(305.6, -1419.7, 41.5),
				Marker = { type = 34, x = 1.5, y = 1.5, z = 1.5, r = 100, g = 150, b = 150, a = 100, rotate = true },
				SpawnPoints = {
					{ coords = vector3(289.9, -608.61, 43.35), heading = 142.7, radius = 10.0 },
					{ coords = vector3(242.59, -565.45, 43.28), heading = 142.7, radius = 10.0 }
				}
			}
		},
